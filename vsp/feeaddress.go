...
func (v *VSP) GetFeeAddress(ctx context.Context, ticketHash *chainhash.Hash) (dcrutil.Amount, error) {
	...
	votingAddr, err := wallet.ParseAddress(scriptVersion, pkScript, v.params)
	if err != nil {
	...
	commitmentAddr, err := wallet.ParseTicketCommitmentAddress(pkScript, v.params)
	if err != nil {
	...
	feeAddr, err := wallet.DecodeAddress(feeResponse.FeeAddress, v.params)
	if err != nil {
