...
type DecodedTransaction_ScriptPubKeyResult_ScriptClass int32

const (
	DecodedTransaction_ScriptPubKeyResult_NONSTANDARDTY     DecodedTransaction_ScriptPubKeyResult_ScriptClass = 0
	DecodedTransaction_ScriptPubKeyResult_PUBKEYTY          DecodedTransaction_ScriptPubKeyResult_ScriptClass = 1
	DecodedTransaction_ScriptPubKeyResult_PUBKEYHASHTY      DecodedTransaction_ScriptPubKeyResult_ScriptClass = 2
	DecodedTransaction_ScriptPubKeyResult_SCRIPTHASHTY      DecodedTransaction_ScriptPubKeyResult_ScriptClass = 3
	DecodedTransaction_ScriptPubKeyResult_MULTISIGTY        DecodedTransaction_ScriptPubKeyResult_ScriptClass = 4
	DecodedTransaction_ScriptPubKeyResult_NULLDATATY        DecodedTransaction_ScriptPubKeyResult_ScriptClass = 5
	DecodedTransaction_ScriptPubKeyResult_STAKESUBMISSIONTY DecodedTransaction_ScriptPubKeyResult_ScriptClass = 6
	DecodedTransaction_ScriptPubKeyResult_STAKEGENTY        DecodedTransaction_ScriptPubKeyResult_ScriptClass = 7
	DecodedTransaction_ScriptPubKeyResult_STAKEREVOCATIONTY DecodedTransaction_ScriptPubKeyResult_ScriptClass = 8
	DecodedTransaction_ScriptPubKeyResult_STAKESUBCHANGETY  DecodedTransaction_ScriptPubKeyResult_ScriptClass = 9
	DecodedTransaction_ScriptPubKeyResult_PUBKEYALTTY       DecodedTransaction_ScriptPubKeyResult_ScriptClass = 10
	DecodedTransaction_ScriptPubKeyResult_PUBKEYHASHALTTY   DecodedTransaction_ScriptPubKeyResult_ScriptClass = 11
)

var DecodedTransaction_ScriptPubKeyResult_ScriptClass_name = map[int32]string{
	0:  "NONSTANDARDTY",
	1:  "PUBKEYTY",
	2:  "PUBKEYHASHTY",
	3:  "SCRIPTHASHTY",
...
var DecodedTransaction_ScriptPubKeyResult_ScriptClass_value = map[string]int32{
	"NONSTANDARDTY":     0,
	"PUBKEYTY":          1,
	"PUBKEYHASHTY":      2,
	"SCRIPTHASHTY":      3,
...
func (x DecodedTransaction_ScriptPubKeyResult_ScriptClass) String() string {
	return proto.EnumName(DecodedTransaction_ScriptPubKeyResult_ScriptClass_name, int32(x))
}
func (DecodedTransaction_ScriptPubKeyResult_ScriptClass) EnumDescriptor() ([]byte, []int) {
...
type DecodedTransaction struct {
	...
	Inputs          []*DecodedTransaction_Input  `protobuf:"bytes,5,rep,name=inputs" json:"inputs,omitempty"`
	Outputs         []*DecodedTransaction_Output `protobuf:"bytes,6,rep,name=outputs" json:"outputs,omitempty"`
}
...
type DecodedTransaction_ScriptPubKeyResult struct {
	Script             []byte                                            `protobuf:"bytes,1,opt,name=script,proto3" json:"script,omitempty"`
	ScriptAsm          string                                            `protobuf:"bytes,2,opt,name=script_asm,json=scriptAsm" json:"script_asm,omitempty"`
	RequiredSignatures int32                                             `protobuf:"varint,3,opt,name=required_signatures,json=requiredSignatures" json:"required_signatures,omitempty"`
	ScriptClass        DecodedTransaction_ScriptPubKeyResult_ScriptClass `protobuf:"varint,4,opt,name=script_class,json=scriptClass,enum=walletrpc.DecodedTransaction_ScriptPubKeyResult_ScriptClass" json:"script_class,omitempty"`
	Addresses          []string                                          `protobuf:"bytes,5,rep,name=addresses" json:"addresses,omitempty"`
	CommitmentAmount   int64                                             `protobuf:"varint,6,opt,name=commitment_amount,json=commitmentAmount" json:"commitment_amount,omitempty"`
}

func (m *DecodedTransaction_ScriptPubKeyResult) Reset()         { *m = DecodedTransaction_ScriptPubKeyResult{} }
func (m *DecodedTransaction_ScriptPubKeyResult) String() string { return proto.CompactTextString(m) }
func (*DecodedTransaction_ScriptPubKeyResult) ProtoMessage()    {}
func (*DecodedTransaction_ScriptPubKeyResult) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{117, 0}
}

func (m *DecodedTransaction_ScriptPubKeyResult) GetScript() []byte {
	if m != nil {
		return m.Script
	}
	return nil
...
func (m *DecodedTransaction_ScriptPubKeyResult) GetScriptAsm() string {
	if m != nil {
		return m.ScriptAsm
	}
	return ""
...
func (m *DecodedTransaction_ScriptPubKeyResult) GetRequiredSignatures() int32 {
	if m != nil {
...
func (m *DecodedTransaction_ScriptPubKeyResult) GetScriptClass() DecodedTransaction_ScriptPubKeyResult_ScriptClass {
	if m != nil {
		return m.ScriptClass
	}
	return DecodedTransaction_ScriptPubKeyResult_NONSTANDARDTY
}

func (m *DecodedTransaction_ScriptPubKeyResult) GetAddresses() []string {
	if m != nil {
		return m.Addresses
	}
	return nil
...
func (m *DecodedTransaction_ScriptPubKeyResult) GetCommitmentAmount() int64 {
	if m != nil {
...
type DecodedTransaction_Input struct {
	CoinbaseScript           []byte                            `protobuf:"bytes,1,opt,name=coinbase_script,json=coinbaseScript,proto3" json:"coinbase_script,omitempty"`
	StakebaseScript          []byte                            `protobuf:"bytes,2,opt,name=stakebase_script,json=stakebaseScript,proto3" json:"stakebase_script,omitempty"`
	PreviousTransactionHash  []byte                            `protobuf:"bytes,3,opt,name=previous_transaction_hash,json=previousTransactionHash,proto3" json:"previous_transaction_hash,omitempty"`
	PreviousTransactionIndex uint32                            `protobuf:"varint,4,opt,name=previous_transaction_index,json=previousTransactionIndex" json:"previous_transaction_index,omitempty"`
	Tree                     DecodedTransaction_Input_TreeType `protobuf:"varint,5,opt,name=tree,enum=walletrpc.DecodedTransaction_Input_TreeType" json:"tree,omitempty"`
	Sequence                 uint32                            `protobuf:"varint,6,opt,name=sequence" json:"sequence,omitempty"`
	AmountIn                 int64                             `protobuf:"varint,7,opt,name=amount_in,json=amountIn" json:"amount_in,omitempty"`
	BlockHeight              uint32                            `protobuf:"varint,8,opt,name=block_height,json=blockHeight" json:"block_height,omitempty"`
	BlockIndex               uint32                            `protobuf:"varint,9,opt,name=block_index,json=blockIndex" json:"block_index,omitempty"`
	ScriptSig                []byte                            `protobuf:"bytes,10,opt,name=script_sig,json=scriptSig,proto3" json:"script_sig,omitempty"`
	ScriptSigAsm             string                            `protobuf:"bytes,11,opt,name=script_sig_asm,json=scriptSigAsm" json:"script_sig_asm,omitempty"`
}
...
func (*DecodedTransaction_Input) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{117, 1} }

func (m *DecodedTransaction_Input) GetCoinbaseScript() []byte {
	if m != nil {
		return m.CoinbaseScript
	}
	return nil
}

func (m *DecodedTransaction_Input) GetStakebaseScript() []byte {
	if m != nil {
		return m.StakebaseScript
	}
	return nil
}
...
func (m *DecodedTransaction_Input) GetScriptSig() []byte {
	if m != nil {
		return m.ScriptSig
	}
	return nil
...
func (m *DecodedTransaction_Input) GetScriptSigAsm() string {
	if m != nil {
		return m.ScriptSigAsm
	}
	return ""
}
...
type DecodedTransaction_Output struct {
	...
	ScriptPubKey *DecodedTransaction_ScriptPubKeyResult `protobuf:"bytes,4,opt,name=script_pub_key,json=scriptPubKey" json:"script_pub_key,omitempty"`
}
...
func (*DecodedTransaction_Output) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{117, 2} }
...
func (m *DecodedTransaction_Output) GetN() uint32 {
	if m != nil {
		return m.N
	}
	return 0
...
func (m *DecodedTransaction_Output) GetScriptPubKey() *DecodedTransaction_ScriptPubKeyResult {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*DecodedTransaction_ScriptPubKeyResult)(nil), "walletrpc.DecodedTransaction.ScriptPubKeyResult")
	...
	proto.RegisterEnum("walletrpc.DecodedTransaction_ScriptPubKeyResult_ScriptClass", DecodedTransaction_ScriptPubKeyResult_ScriptClass_name, DecodedTransaction_ScriptPubKeyResult_ScriptClass_value)
...
var fileDescriptor0 = []byte{
	...
	,
}
