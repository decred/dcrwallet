...
It has these top-level messages:
	...
	SummaryResultDataPoint
	SummaryResult
	CalculateSummaryResponse
	AvailableSummariesRequest
	AvailableSummariesResponse
*/
package walletrpc
...
type CalculateSummaryRequest_SummaryResolution int32

const (
	CalculateSummaryRequest_Block CalculateSummaryRequest_SummaryResolution = 0
	CalculateSummaryRequest_Hour  CalculateSummaryRequest_SummaryResolution = 1
	CalculateSummaryRequest_Day   CalculateSummaryRequest_SummaryResolution = 2
	CalculateSummaryRequest_Month CalculateSummaryRequest_SummaryResolution = 3
	CalculateSummaryRequest_Year  CalculateSummaryRequest_SummaryResolution = 4
	CalculateSummaryRequest_All   CalculateSummaryRequest_SummaryResolution = 5
)

var CalculateSummaryRequest_SummaryResolution_name = map[int32]string{
	0: "Block",
	1: "Hour",
	2: "Day",
	3: "Month",
...
var CalculateSummaryRequest_SummaryResolution_value = map[string]int32{
	"Block": 0,
	"Hour":  1,
	"Day":   2,
	"Month": 3,
...
func (x CalculateSummaryRequest_SummaryResolution) String() string {
	return proto.EnumName(CalculateSummaryRequest_SummaryResolution_name, int32(x))
}
func (CalculateSummaryRequest_SummaryResolution) EnumDescriptor() ([]byte, []int) {
...
type CalculateSummaryRequest struct {
	...
	Resolution  CalculateSummaryRequest_SummaryResolution `protobuf:"varint,2,opt,name=resolution,enum=walletrpc.CalculateSummaryRequest_SummaryResolution" json:"resolution,omitempty"`
	BeginHeight int32                                     `protobuf:"varint,3,opt,name=begin_height,json=beginHeight" json:"begin_height,omitempty"`
	EndHeight   int32                                     `protobuf:"varint,4,opt,name=end_height,json=endHeight" json:"end_height,omitempty"`
}

func (m *CalculateSummaryRequest) Reset()                    { *m = CalculateSummaryRequest{} }
func (m *CalculateSummaryRequest) String() string            { return proto.CompactTextString(m) }
func (*CalculateSummaryRequest) ProtoMessage()               {}
func (*CalculateSummaryRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{124} }

func (m *CalculateSummaryRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *CalculateSummaryRequest) GetResolution() CalculateSummaryRequest_SummaryResolution {
	if m != nil {
		return m.Resolution
	}
	return CalculateSummaryRequest_Block
}

func (m *CalculateSummaryRequest) GetBeginHeight() int32 {
	if m != nil {
		return m.BeginHeight
	}
	return 0
...
func (m *CalculateSummaryRequest) GetEndHeight() int32 {
	if m != nil {
		return m.EndHeight
	}
	return 0
...
type SummaryResultDataPoint struct {
	...
	//	*SummaryResultDataPoint_IntValue
	//	*SummaryResultDataPoint_FloatValue
	ValueOneof isSummaryResultDataPoint_ValueOneof `protobuf_oneof:"value_oneof"`
}

func (m *SummaryResultDataPoint) Reset()                    { *m = SummaryResultDataPoint{} }
func (m *SummaryResultDataPoint) String() string            { return proto.CompactTextString(m) }
func (*SummaryResultDataPoint) ProtoMessage()               {}
func (*SummaryResultDataPoint) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{125} }

type isSummaryResultDataPoint_ValueOneof interface {
	isSummaryResultDataPoint_ValueOneof()
}

type SummaryResultDataPoint_IntValue struct {
	IntValue int64 `protobuf:"varint,1,opt,name=int_value,json=intValue,oneof"`
}
type SummaryResultDataPoint_FloatValue struct {
	FloatValue float64 `protobuf:"fixed64,2,opt,name=float_value,json=floatValue,oneof"`
}

func (*SummaryResultDataPoint_IntValue) isSummaryResultDataPoint_ValueOneof()   {}
func (*SummaryResultDataPoint_FloatValue) isSummaryResultDataPoint_ValueOneof() {}

func (m *SummaryResultDataPoint) GetValueOneof() isSummaryResultDataPoint_ValueOneof {
	if m != nil {
		return m.ValueOneof
	}
	return nil
...
func (m *SummaryResultDataPoint) GetIntValue() int64 {
	if x, ok := m.GetValueOneof().(*SummaryResultDataPoint_IntValue); ok {
		return x.IntValue
	}
	return 0
}

func (m *SummaryResultDataPoint) GetFloatValue() float64 {
	if x, ok := m.GetValueOneof().(*SummaryResultDataPoint_FloatValue); ok {
		return x.FloatValue
	}
	return 0
}
...
func (*SummaryResultDataPoint) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _SummaryResultDataPoint_OneofMarshaler, _SummaryResultDataPoint_OneofUnmarshaler, _SummaryResultDataPoint_OneofSizer, []interface{}{
		(*SummaryResultDataPoint_IntValue)(nil),
		(*SummaryResultDataPoint_FloatValue)(nil),
	}
}

func _SummaryResultDataPoint_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*SummaryResultDataPoint)
	// value_oneof
	switch x := m.ValueOneof.(type) {
	case *SummaryResultDataPoint_IntValue:
		b.EncodeVarint(1<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.IntValue))
	case *SummaryResultDataPoint_FloatValue:
		b.EncodeVarint(2<<3 | proto.WireFixed64)
		b.EncodeFixed64(math.Float64bits(x.FloatValue))
	case nil:
	default:
		return fmt.Errorf("SummaryResultDataPoint.ValueOneof has unexpected type %T", x)
	}
	return nil
}

func _SummaryResultDataPoint_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*SummaryResultDataPoint)
	switch tag {
	case 1: // value_oneof.int_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.ValueOneof = &SummaryResultDataPoint_IntValue{int64(x)}
		return true, err
	case 2: // value_oneof.float_value
		if wire != proto.WireFixed64 {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeFixed64()
		m.ValueOneof = &SummaryResultDataPoint_FloatValue{math.Float64frombits(x)}
		return true, err
	default:
		return false, nil
	}
...
func _SummaryResultDataPoint_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*SummaryResultDataPoint)
	// value_oneof
	switch x := m.ValueOneof.(type) {
	case *SummaryResultDataPoint_IntValue:
...
type SummaryResult struct {
	...
	Data      map[uint32]*SummaryResultDataPoint `protobuf:"bytes,2,rep,name=data" json:"data,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}

func (m *SummaryResult) Reset()                    { *m = SummaryResult{} }
func (m *SummaryResult) String() string            { return proto.CompactTextString(m) }
func (*SummaryResult) ProtoMessage()               {}
func (*SummaryResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{126} }

func (m *SummaryResult) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *SummaryResult) GetData() map[uint32]*SummaryResultDataPoint {
	if m != nil {
		return m.Data
	}
	return nil
...
type CalculateSummaryResponse struct {
	Result *SummaryResult `protobuf:"bytes,1,opt,name=result" json:"result,omitempty"`
}

func (m *CalculateSummaryResponse) Reset()                    { *m = CalculateSummaryResponse{} }
func (m *CalculateSummaryResponse) String() string            { return proto.CompactTextString(m) }
func (*CalculateSummaryResponse) ProtoMessage()               {}
func (*CalculateSummaryResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{127} }

func (m *CalculateSummaryResponse) GetResult() *SummaryResult {
	if m != nil {
		return m.Result
	}
	return nil
...
type AvailableSummariesRequest struct {
}

func (m *AvailableSummariesRequest) Reset()                    { *m = AvailableSummariesRequest{} }
func (m *AvailableSummariesRequest) String() string            { return proto.CompactTextString(m) }
func (*AvailableSummariesRequest) ProtoMessage()               {}
func (*AvailableSummariesRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{128} }

type AvailableSummariesResponse struct {
	Name []string `protobuf:"bytes,1,rep,name=name" json:"name,omitempty"`
}

func (m *AvailableSummariesResponse) Reset()                    { *m = AvailableSummariesResponse{} }
func (m *AvailableSummariesResponse) String() string            { return proto.CompactTextString(m) }
func (*AvailableSummariesResponse) ProtoMessage()               {}
func (*AvailableSummariesResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{129} }

func (m *AvailableSummariesResponse) GetName() []string {
	if m != nil {
		return m.Name
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CalculateSummaryRequest)(nil), "walletrpc.CalculateSummaryRequest")
	proto.RegisterType((*SummaryResultDataPoint)(nil), "walletrpc.SummaryResultDataPoint")
	proto.RegisterType((*SummaryResult)(nil), "walletrpc.SummaryResult")
	proto.RegisterType((*CalculateSummaryResponse)(nil), "walletrpc.CalculateSummaryResponse")
	proto.RegisterType((*AvailableSummariesRequest)(nil), "walletrpc.AvailableSummariesRequest")
	proto.RegisterType((*AvailableSummariesResponse)(nil), "walletrpc.AvailableSummariesResponse")
	...
	proto.RegisterEnum("walletrpc.CalculateSummaryRequest_SummaryResolution", CalculateSummaryRequest_SummaryResolution_name, CalculateSummaryRequest_SummaryResolution_value)
}
...
// Client API for SummariesService service

type SummariesServiceClient interface {
	CalculateSummary(ctx context.Context, in *CalculateSummaryRequest, opts ...grpc.CallOption) (SummariesService_CalculateSummaryClient, error)
	AvailableSummaries(ctx context.Context, in *AvailableSummariesRequest, opts ...grpc.CallOption) (*AvailableSummariesResponse, error)
}

type summariesServiceClient struct {
	cc *grpc.ClientConn
}

func NewSummariesServiceClient(cc *grpc.ClientConn) SummariesServiceClient {
	return &summariesServiceClient{cc}
}

func (c *summariesServiceClient) CalculateSummary(ctx context.Context, in *CalculateSummaryRequest, opts ...grpc.CallOption) (SummariesService_CalculateSummaryClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_SummariesService_serviceDesc.Streams[0], c.cc, "/walletrpc.SummariesService/CalculateSummary", opts...)
	if err != nil {
		return nil, err
	}
	x := &summariesServiceCalculateSummaryClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type SummariesService_CalculateSummaryClient interface {
	Recv() (*CalculateSummaryResponse, error)
	grpc.ClientStream
}

type summariesServiceCalculateSummaryClient struct {
	grpc.ClientStream
}

func (x *summariesServiceCalculateSummaryClient) Recv() (*CalculateSummaryResponse, error) {
	m := new(CalculateSummaryResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *summariesServiceClient) AvailableSummaries(ctx context.Context, in *AvailableSummariesRequest, opts ...grpc.CallOption) (*AvailableSummariesResponse, error) {
	out := new(AvailableSummariesResponse)
	err := grpc.Invoke(ctx, "/walletrpc.SummariesService/AvailableSummaries", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for SummariesService service

type SummariesServiceServer interface {
	CalculateSummary(*CalculateSummaryRequest, SummariesService_CalculateSummaryServer) error
	AvailableSummaries(context.Context, *AvailableSummariesRequest) (*AvailableSummariesResponse, error)
}

func RegisterSummariesServiceServer(s *grpc.Server, srv SummariesServiceServer) {
	s.RegisterService(&_SummariesService_serviceDesc, srv)
}

func _SummariesService_CalculateSummary_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(CalculateSummaryRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SummariesServiceServer).CalculateSummary(m, &summariesServiceCalculateSummaryServer{stream})
}

type SummariesService_CalculateSummaryServer interface {
	Send(*CalculateSummaryResponse) error
	grpc.ServerStream
}

type summariesServiceCalculateSummaryServer struct {
	grpc.ServerStream
}

func (x *summariesServiceCalculateSummaryServer) Send(m *CalculateSummaryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _SummariesService_AvailableSummaries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AvailableSummariesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SummariesServiceServer).AvailableSummaries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/walletrpc.SummariesService/AvailableSummaries",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SummariesServiceServer).AvailableSummaries(ctx, req.(*AvailableSummariesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _SummariesService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "walletrpc.SummariesService",
	HandlerType: (*SummariesServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AvailableSummaries",
			Handler:    _SummariesService_AvailableSummaries_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "CalculateSummary",
			Handler:       _SummariesService_CalculateSummary_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "api.proto",
...
var fileDescriptor0 = []byte{
	// 7242 bytes of a gzipped FileDescriptorProto
	,
}
