...
// func makeFakeBlockMeta(height int32) BlockMeta {
// 	if height == -1 {
...
// 	missingBlock := makeFakeBlockMeta(102)
...
// 	})
// 	newState = lastState.deepCopy()
// 	newState.blocks[0][0].Block = makeFakeBlockMeta(-1)
// 	newState.blocks[0][1].Block = makeFakeBlockMeta(-1)
// 	newState.txDetails[recA.Hash][0].Block = makeFakeBlockMeta(-1)
// 	newState.txDetails[recB.Hash][0].Block = makeFakeBlockMeta(-1)
// 	lastState = newState
// 	tests = append(tests, queryTest{
