...
func TestStakePoolTicketFee(t *testing.T) {
	...
	tests := []struct {
		...
		0: {10 * 1e8, 0.01 * 1e8, 25000, 100, 0.01500463 * 1e8},
		1: {20 * 1e8, 0.01 * 1e8, 25000, 100, 0.01621221 * 1e8},
		2: {5 * 1e8, 0.05 * 1e8, 50000, 259, 0.03310616 * 1e8},
		3: {15 * 1e8, 0.05 * 1e8, 50000, 259, 0.03956376 * 1e8},
	}
