...
var helpDescsEnUS = map[string]string{
	...
	"infowalletresult-paytxfee":        "The fee per kb used each time more fee is required for an authored transaction",
	...
	// SetTxFeeCmd help.
	"settxfee--synopsis": "Modify the fee per kb used each time more fee is required for an authored transaction.",
	"settxfee-amount":    "The new fee per kb valued in decred",
	...
	"walletinforesult-txfee":             "Transaction fee per kb in coins",
	"walletinforesult-ticketfee":         "Ticket fee per kb in coins",
	...
	"setticketfee--synopsis": "Modify the fee per kb  used each time more fee is required for an authored stake transaction.",
	"setticketfee-fee":       "The new fee per kb valued in decred",
	"setticketfee--result0":  "The boolean 'true'",

	// GetTicketFeeCmd help.
	"getticketfee--synopsis": "Get the current fee per kb used for an authored stake transaction.",
