...
var helpDescsEnUS = map[string]string{
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in ExchangeCoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in ExchangeCoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in ExchangeCoin",
	...
	"listaccounts--result0--value": "The account balance valued in ExchangeCoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in ExchangeCoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in ExchangeCoin",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in ExchangeCoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in ExchangeCoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in ExchangeCoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in ExchangeCoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in ExchangeCoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in ExchangeCoin",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in ExchangeCoin",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in ExchangeCoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in ExchangeCoin.",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in ExchangeCoin",
